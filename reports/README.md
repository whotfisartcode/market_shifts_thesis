...
- `reports/target_tweak_experiments/` - dashboard target-tweak and feature-set summary tables.
- `reports/figures/dashboard/` - dashboard screenshots.

Deep experiment folders, audit logs, tuning archives, and legacy plots are intentionally excluded from GitHub to keep the package readable.
