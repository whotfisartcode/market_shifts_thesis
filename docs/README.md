...
Start with these files when reading the thesis methodology and package logic.

## Main Project Notes

- `CURRENT_STATUS.md` - current project state and final counts.
- `FINAL_SOURCE_OF_TRUTH_INDEX.md` - source-of-truth map for final thesis claims.
- `DATA_MANIFEST.md` - data sources and package contents.
